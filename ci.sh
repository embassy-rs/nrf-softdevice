...
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-l2cap,ble-gatt-client,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-l2cap,ble-gatt-client,ble-gatt-server,defmt
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-l2cap,ble-gatt-client,ble-gatt-server,log
...
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s112,nrf52805,ble-bond,ble-peripheral,ble-gatt-client,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s113,nrf52810,ble-bond,ble-peripheral,ble-l2cap,ble-gatt-client,ble-gatt-server
...
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s132,nrf52832,ble-bond,ble-central,ble-peripheral,ble-l2cap,ble-gatt-client,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52811,ble-bond,ble-central,ble-peripheral,ble-l2cap,ble-gatt-client,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52820,ble-bond,ble-central,ble-peripheral,ble-l2cap,ble-gatt-client,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-l2cap,ble-gatt-client,ble-gatt-server
...
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-peripheral
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-peripheral,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-peripheral,ble-gatt-client
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-peripheral,ble-gatt-client,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-peripheral,ble-l2cap
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-peripheral,ble-l2cap,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-peripheral,ble-l2cap,ble-gatt-client
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-peripheral,ble-l2cap,ble-gatt-client,ble-gatt-server

cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-gatt-client
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-gatt-client,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-l2cap
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-l2cap,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-l2cap,ble-gatt-client
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-l2cap,ble-gatt-client,ble-gatt-server
cargo build --target thumbv7em-none-eabihf -p nrf-softdevice --features s140,nrf52840,ble-bond,ble-central,ble-peripheral,ble-l2cap,ble-gatt-client,ble-gatt-server,ble-l2cap-credit-wrokaround,ble-rssi
